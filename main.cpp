...
//TODO: move validation and layers to an external
// config file style format, have those get passed into the init
const std::vector<const char *> validationLayers = {"VK_LAYER_KHRONOS_validation"};
const std::vector<const char *> deviceExtensions = {VK_KHR_SWAPCHAIN_EXTENSION_NAME};

// Anonymous namespace for state and single use functions for init.

namespace
{
    //TODO IMMEDIATE: nuke this idea from space, these should 
    ...
    //confirm that validation layers requested exist
    ...
    //Find and select graphics card 
    //TODO: create heuristic for which card
...
namespace SPRenderState
{
    ...
    void SPrsCreateCommandPool()
    {
        ...
        createInfo.pNext = nullptr;
        createInfo.flags = VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT; //resetable command buffer
    }
