...
void VulkanRenderPass::init(VkDevice device)
{
    ...
    VkAttachmentDescription attachmentDesc = createAttachmentDescription();
    ...
    renderPassInfo.pDependencies = nullptr; //TODO: set this up. These seem to be necessary for sync
...
VkAttachmentDescription VulkanRenderPass::createAttachmentDescription()
{
    ...
    attachmentDesc.samples = VK_SAMPLE_COUNT_1_BIT; //msaa?
    attachmentDesc.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED;
    attachmentDesc.finalLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; //TODO: write to a back buffer, this is writing directly to swap chain
